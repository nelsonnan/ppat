...
#define SHKMyAppName			@"Edgy Camera"
#define SHKMyAppURL				@"http://edgy.levelview.com/"
...
#define SHKFacebookKey				@"b61a8ae3c36555416c3e3402b11beb43"
#define SHKFacebookSecret			@"509640a43f8e2a27e1edf5e0f3cea2a7"
 ...
 */
#define SHKTwitterConsumerKey		@"Qpmnc2g38KhWCDhaQaFPPQ"
#define SHKTwitterSecret			@"qpmcWNk7tnakhLFU8R3u3RVK8G7exL9W6oTrmbZ2qA"
#define SHKTwitterCallbackUrl		@"http://edgy-callback-url.edgy.levelview.com/" // You need to set this if using OAuth, see note above (xAuth users can skip it)
